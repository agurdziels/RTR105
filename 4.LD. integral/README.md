# 4.LD integral
Šajā labratorijas darbā tika realizēta programma, kas aprēķina integrāļa vērtību ar taisnstūra, trapeču un Simpsona metodi. Ievērojama atšķirība bija veikto ciklu skaitā, kas tika izpildīti, lai aprēķinātu integrāli. Iegūtais integrālis sakrita ar wolframalpha rezultātu.
### Uzrakstītais kods:
```
#include<stdio.h>
#include<math.h>
